...
import { RequestInterface } from "../../interfaces/express"
...
export const auth_middleware = (req: RequestInterface, res: Response, next: NextFunction, auth_mode = Auth.IS_LOGGED_IN) => {
    let token: any
    if (req.header)
